...
public class ForumUserTestSuite {
    ...
    public void testGetLocationsOfFriends(){
        ...
        // user1.addFriends(ForumUser user) do user1 dodaję przyjaciela, tu: user3/7/10 wraz z pełną zawartością wyżej
...
// oczekuję, że doda się 3 przyjaciół dla user1, a dokładniej ich TRZY lokalizacje
        Assert.assertEquals(3,user1.getLocationsOfFriends().size());

//sprawdzam czy dodani przyjaciele/lokalizacje są zgodne z tym, co podałam niżej.
        ...
        Assert.assertFalse(user1.getLocationsOfFriends().contains("Orlando")); //tu jest assertFalse
    }
    ...
    public void testGetLocationsOfFriendsOfFriends(){
        ...
        //Then
        //user1 has 3 friends with the following friends and their locations:
...
//Powyższy test sprawdza, czy lista lokalizacji "przyjaciół przyjaciół" zawiera dokładnie 3 lokalizacje.
// Sprawdza również czy konkretne - oczekiwane lokalizacje - rzeczywiście występują w kolekcji wynikowej.
// czy user1 ma dodanych 3 przyjaciół

// test prawie identyczny jak wyzej, ALE tu mam metodę .getLocationsOfFriendsOfFriends
        ...
        Assert.assertFalse(user1.getLocationsOfFriendsOfFriends().contains("Orlando")); //tu jest assertFalse
